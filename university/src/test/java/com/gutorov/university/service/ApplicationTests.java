...
public class ApplicationTests {
    ...
    void getEntity_WithExistingId_ReturnsApplication() {
        final var program = programService.create(programMapper.toRequest("Program 1"));
        final var application = applicationService.create(
                applicationMapper.toRequest(
    ...
    void getAll_WithNotEmptyRepository_ReturnsApplications() {
        final var program = programService.create(programMapper.toRequest("Program 1"));
        applicationService.create(applicationMapper.toRequest(
                "Application 1", "example@mail.ru", program.getId(), LocalDateTime.now(), false));
        applicationService.create(applicationMapper.toRequest(
                "Application 2", "example@mail.ru", program.getId(), LocalDateTime.now(), false));
        applicationService.create(applicationMapper.toRequest(
                "Application 3", "example@mail.ru", program.getId(), LocalDateTime.now(), false));
    ...
    void get_WithNotEmptyRepository_ReturnsApplication() {
        final var program = programService.create(programMapper.toRequest("Program 1"));
        final var application = applicationService.create(applicationMapper.toRequest(
                "Application 1", "example@mail.ru", program.getId(), LocalDateTime.now(), false));
    ...
    void create_WithValidData_ReturnApplication() {
        final var program = programService.create(programMapper.toRequest("Program 1"));
        final var createdApplication = applicationService.create(applicationMapper.toRequest(
                "Application 1", "example@mail.ru", program.getId(), LocalDateTime.now(), false));
    ...
    void update_WithValidData_ReturnsUpdatedApplication() {
        final var program = programService.create(programMapper.toRequest("Program 1"));
        final var createdApplicationId = applicationService.create(applicationMapper.toRequest(
                "Application 1", "example1@mail.ru", program.getId(), LocalDateTime.now(), false)).getId();
        final var updatedApplication = applicationService.update(createdApplicationId, applicationMapper.toRequest(
